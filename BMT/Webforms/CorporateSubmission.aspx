<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CorporateSubmission.aspx.cs"
    Inherits="BMT.Webforms.CorporateSubmission" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="<%= Page.ResolveClientUrl("~/Scripts/corporateSubmission.js") %>"></script>
</head>
