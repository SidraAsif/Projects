...
{
    public partial class MOReUploadedDocs : System.Web.UI.Page
    {
        #region DATA_MEMBER
        ...
        private void DisplayDocs()
        {
            ...
            && Request.QueryString["siteId"] != null && Request.QueryString["projectUsageId"] != null && Request.QueryString["templateId"] != null)
            {
                ...
                int projectUsageId = Convert.ToInt32(Request.QueryString["projectUsageId"]);
                int templateId = Convert.ToInt32(Request.QueryString["templateId"]);
                hdnTemplateId.Value = templateId.ToString();
                Session["TemplateId"] = templateId.ToString();
                hdnSiteId.Value = Request.QueryString["siteId"].ToString();

                // get list of docs + comments
                Session["listNCQADetails"] = _listOfNCQADetail = NCQADataHelper.GetDocsByElementId(pcmhSequenceId, elementSequenceId, practiceId, siteId, projectUsageId, templateId);
