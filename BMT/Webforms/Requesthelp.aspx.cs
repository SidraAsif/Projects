...
{
    public partial class Request_help : System.Web.UI.Page
    {
        ...
        public void RequestHelp(string UserName)
        {
            try
            {
                ...
                message.Subject = Util.GetSystemProjectName(enterpriseId) + "-Help";
        ...
        public void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                RequestHelp(_UserName);
                MsgRequestHelp.Success("Thank you. Your Request has been submitted.");
                ClearFields();
