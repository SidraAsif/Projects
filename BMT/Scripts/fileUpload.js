...
function DocLinkGenerator(selectedDoc, fileTitle) {
    $.ajax({
        type: "POST",
        url: "WebServices/NCQAService.asmx/DocLinkGenerator",
...
function GetElements() {
    $.ajax({
        type: "POST",
        url: "WebServices/NCQAService.asmx/GetNCQAElements",
...
function GetStandards() {
    $.ajax({
        type: "POST",
        url: "WebServices/NCQAService.asmx/GetNCQAStandards",
        data: "{}",
        contentType: "application/json; charset=utf-8",
        success: function (response) {
...
function GetFactors() {
    $.ajax({
        type: "POST",
        url: "WebServices/NCQAService.asmx/GetNCQAFactors",
...
function GetDocs() {
    $.ajax({
        type: "POST",
        url: "WebServices/NCQAService.asmx/GetDocs",
