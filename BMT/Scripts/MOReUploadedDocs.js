...
function ProcessReplaceFile(title, elementId, factorId, PCMHId, ProjectUsageId, Node, PracticeId, SiteId, DocName, ReferencePage, RelevancyLevel, File, DocLinkedTo, DocType) {
    ...
    $('#fuPage').attr('src', '../MOReFileUpload.aspx?elementId=' + elementId + '&templateId=' + TemplateId + '&factorId=' + factorId + '&PCMHId=' + PCMHId + '&ProjectUsageId=' + ProjectUsageId +
                '&PracticeName=' + PracticeName + '&SiteName=' + SiteName + '&Node=' + Node + '&PracticeId=' + PracticeId + '&SiteId=' + SiteId + 
                '&ReferencePage=' + ReferencePage + '&RelevancyLevel=' + RelevancyLevel + '&File=' + File + '&DocLinkedTo=' + DocLinkedTo  + '&DocType=' + DocType + '&DocName=' + DocName
                );
}
...
function UpdateDocStatusOnParentWindow() {
    ...
    if (requiredDocs > newValueOldDocType) {
        window.parent.$('td#CellUploadedDocs' + elementId + factorId + "_" + PCMHId + OldDocTypeValue).removeClass();
        window.parent.$('td#CellUploadedDocs' + elementId + factorId + "_" + PCMHId + OldDocTypeValue).addClass('factor-control-hightlight');
    }
    else {
        window.parent.$('td#CellUploadedDocs' + elementId + factorId + "_" + PCMHId + OldDocTypeValue).removeClass();
        window.parent.$('td#CellUploadedDocs' + elementId + factorId + "_" + PCMHId + OldDocTypeValue).addClass('factor-control-important');
    }
}