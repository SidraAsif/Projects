<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SRATechnology.ascx.cs" ViewStateMode="Enabled"
    Inherits="SRATechnology" %>
...
<table width="100%">
    <tr>
    <td></td>
    <td align="right"><asp:Button ID="btnPrintTechnology" runat="server" Text="Save & Print Technology Now" OnClick="btnPrintTechnology_Click" 
...
<table width="100%">
    ...
    <tr>
        <td align="right" style="padding-right: 5px;">
            <a href="../StDocs/General/Security Risk Assessment - Instructions.pdf#page=9" target="_blank" >Read Instructions for this Tab</a>
        </td>
    </tr>
</table>
<asp:Panel ID="pnlTechnology" runat="server" ClientIDMode="Static">
</asp:Panel>
