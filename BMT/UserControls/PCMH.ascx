<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PCMH.ascx.cs" Inherits="PCMH"
...
<div id="NCQARequirements">
    <asp:Panel ID="pnlNCQARequirements" runat="server">
    </asp:Panel>
                ...
                <td>
                    <asp:Panel ID="pnlDocViewer" runat="server">
                        <iframe id="IframeDocViewer" style="min-height: 400px; height: 400px; overflow: hidden;
                            width: 100%; margin: auto;" src="../Webforms/NCQAUploadedDocs.aspx" frameborder="0"
