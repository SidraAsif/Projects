<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="General.ascx.cs" Inherits="General" %>
...
<div id="lightbox-popup" class="CorporateElement-popup" style="border: 1px solid #5880B3;
        ...
        <table width="100%">
            <tr>
                ...
                <td width="20%" align="right" valign="middle">
                    <a id="close-CorporateElement">close[x]</a>
                </td>
            </tr>
        </table>
    </div>
    ...
    <tr id="visibleOnlyForCorporateSite" runat="server">
        <td>
            <asp:HyperLink ID="hypFacilitator" Text="Corporate Submission" ClientIDMode="Static"
                runat="server" NavigateUrl="javascript:DisplayCorporateElement();"></asp:HyperLink>
        </td>
    </tr>
    <tr class="standard-title">
        <td>
    ...
    <tr>
        <td>
            <asp:GridView ID="gvPrimaryCareProvider" runat="server" AllowPaging="true" AllowSorting="true"
                PageSize="8" AutoGenerateColumns="false" HeaderStyle-BackColor="#5880B3" HeaderStyle-ForeColor="#FFFFFF" HeaderStyle-CssClass="header-border"
                HeaderStyle-HorizontalAlign="Center" OnPageIndexChanging="gvPrimaryCareProvider_OnPageIndexChanging" BorderColor="White" CssClass="submission-grid">
            ...
            <td>
                <asp:Panel ID="pnlFrame" runat="server">
                    <iframe scrolling="no" id="fuPage" style="height: auto; min-height: 280px; width: 100%;
                        overflow: hidden;" src="../FileUpload.aspx" frameborder="0"></iframe>
                </asp:Panel>
            </td>
        </tr>
    </table>
