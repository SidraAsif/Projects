<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MOReSummary.ascx.cs"
    Inherits="MOReSummary" %>
...
<div style="margin-top:4%;width:100%;" id="divTemplateName" runat="server">
</div>
<table width="95%">
    <tr>
...
<asp:HiddenField ID="hdnSummaryProjectUsageId" ClientIDMode="Static" runat="server" />
<asp:HiddenField ID="hdnSiteId" ClientIDMode="Static" runat="server" />
<asp:HiddenField ID="hdnTemplateId" ClientIDMode="Static" runat="server" />
<asp:HiddenField ID="hdnLevel" ClientIDMode="Static" runat="server" />
<asp:Button ID="btnSaveAPICredentials" runat="server" ClientIDMode="Static" Style="display: none;"
    Text="Save" OnClick="btnSaveAPICredentials_Click" />
